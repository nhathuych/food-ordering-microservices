package com.food.ordering.microservices.kafka.consumer.config;

import com.food.ordering.microservices.kafka.config.data.KafkaConfigData;
import com.food.ordering.microservices.kafka.config.data.KafkaConsumerConfigData;
