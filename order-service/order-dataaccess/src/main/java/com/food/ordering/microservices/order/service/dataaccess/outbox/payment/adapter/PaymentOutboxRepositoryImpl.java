package com.food.ordering.microservices.order.service.dataaccess.outbox.payment.adapter;

import com.food.ordering.microservices.order.service.dataaccess.outbox.payment.exception.PaymentOutboxNotFoundException;
import com.food.ordering.microservices.order.service.dataaccess.outbox.payment.mapper.PaymentOutboxDataAccessMapper;
import com.food.ordering.microservices.order.service.dataaccess.outbox.payment.repository.PaymentOutboxJpaRepository;
...
public class PaymentOutboxRepositoryImpl implements PaymentOutboxRepository {
    ...
    public OrderPaymentOutboxMessage save(OrderPaymentOutboxMessage orderPaymentOutboxMessage) {
        return paymentOutboxDataAccessMapper.paymentOutboxEntityToOrderPaymentOutboxMessage(
                paymentOutboxJpaRepository.save(paymentOutboxDataAccessMapper.orderPaymentOutboxMessageToOutboxEntity(orderPaymentOutboxMessage))
        );
    }
